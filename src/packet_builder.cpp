...
void PacketBuilder::buildPacketIPv4(char *packet, const char *src_ip, const char *target_ip, int port, int src_port)
{
...
void PacketBuilder::buildPacketIPv6(char *packet, const char *src_ip, const char *target_ip, int port, int src_port)
{
